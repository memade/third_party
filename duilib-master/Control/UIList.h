...
#define UILIST_MAX_COLUMNS 32
	...
	public:
		...
		bool UnSel1ectItem(int iIndex, bool bOthers = false);
		void SelectAllItems();
		...
		CControlUI* GetItemAtByTag(const UINT_PTR&) const;
		CControlUI* GetItemAtByTagINT64(const INT64&) const;
		CControlUI* GetItemAtByTagUINT64(const UINT64&) const;
		...
		BOOL SortItems(const PULVCompareFunc& pfnCompare, UINT_PTR dwData);
	...
	public:
		...
		void SetText(int iIndex, LPCTSTR pstrText, DWORD dwColor);
